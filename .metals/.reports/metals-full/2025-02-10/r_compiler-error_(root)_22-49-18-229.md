...
def choice(): Unit = {}
  val choosenDoor = StdIn.readLine()
  if choosenDoor == "Left" || "Right" then 
...
scala.runtime.Scala3RunTime$.assertFailed(Scala3RunTime.scala:11)
	...
	dotty.tools.dotc.core.tasty.TreeUnpickler.dotty$tools$dotc$core$tasty$TreeUnpickler$TreeReader$$_$constructorApply$1(TreeUnpickler.scala:1261)
	dotty.tools.dotc.core.tasty.TreeUnpickler$TreeReader.readLengthTree$1(TreeUnpickler.scala:1303)
	dotty.tools.dotc.core.tasty.TreeUnpickler$TreeReader.readTree(TreeUnpickler.scala:1471)
	dotty.tools.dotc.core.tasty.TreeUnpickler.$anonfun$16$$anonfun$1(TreeUnpickler.scala:745)
	dotty.tools.dotc.core.tasty.TreeUnpickler$LazyReader.complete(TreeUnpickler.scala:1608)
	dotty.tools.dotc.core.tasty.TreeUnpickler.$anon$superArg$2$1$$anonfun$1(TreeUnpickler.scala:747)
